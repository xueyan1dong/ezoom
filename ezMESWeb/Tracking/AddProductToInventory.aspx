<%@ Page Language="C#" MasterPageFile="~/Tracking/TrackingModule.master" AutoEventWireup="true" CodeBehind="AddProductToInventory.aspx.cs" Inherits="ezMESWeb.Tracking.AddProductToInventory" Title="Add Final Product To Inventory Step -- ezOOM" %>
