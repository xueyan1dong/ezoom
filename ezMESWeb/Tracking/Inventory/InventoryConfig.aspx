   ...
   <asp:UpdatePanel ID="gvTablePanel" runat="server" UpdateMode="Conditional">
			...
			<td align="center">
             ...
             <asp:CoolGridView ID="gvTable" runat="server" Caption="" 
               ...
               AutoGenerateColumns="False" AutoGenerateDeleteButton="True" DataKeyNames="id" FixHeaders="true"
               onselectedindexchanged="gvTable_SelectedIndexChanged" AllowPaging="True"  AllowSorting="true" PageSize="15" Width="860px" Height="480px" AllowResizeColumn="true" 
