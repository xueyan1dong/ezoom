<%@ Page Language="C#" MasterPageFile="~/Tracking/TrackingModule.Master" AutoEventWireup="true" CodeBehind="LoadInventoryGeneral.aspx.cs" Inherits="ezMESWeb.Tracking.Inventory.LoadInventoryGeneral" Title="Load Inventory General-- ezOOM" %>
...
<asp:Label ID="lblError" runat="server" ForeColor="#FF3300" 
    ...
    <p>Required columns: Source_Type, Name, Supplier, Batch_Number, Serial_Number, Purchase_PO, Sales_PO, Original_Quantity, Actual_Quantity, Location, Unit, Manufacture_Date, Expiration_Date, Arrive_Date, Contact, Comment.</p><br />
