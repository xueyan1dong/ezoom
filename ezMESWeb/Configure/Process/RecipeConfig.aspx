...
<table style="width: 100%; height: 423px; margin-right: 0px; margin-top: 0px; border : 2px solid #6FBD06; ">
      ...
      <tr>
       ...
       <asp:SqlDataSource ID="sdsGrid" runat="server" 
        ...
        i.ingredient_id,
        p.name,
        concat(CAST(CAST(i.quantity AS UNSIGNED INTEGER) AS CHAR), ' ', u.name) AS quantity,
        i.`order`,
        i.mintime,
        i.maxtime,
        i.comment
 ...
 SELECT i1.recipe_id,
        ...
        i1.ingredient_id,
         m.name,
        concat(CAST(CAST(i1.quantity AS UNSIGNED INTEGER) AS CHAR), ' ', u1.name) AS quantity,
        i1.`order`,
        i1.mintime,
        i1.maxtime,
        i1.comment
