...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div>
    <asp:panel id="pnlScroll" runat="server" scrollbars="none" style="Width:92%; padding:0px; border:0px;"> 
    <asp:UpdatePanel ID="gvTablePanel" runat="server" UpdateMode="Conditional">
        <ContentTemplate>
            <%-- <table style="width: 100%; height: 423px; margin-right: 0px; margin-top: 0px; border : 2px solid #6FBD06; ">
                ...
                <table style="width:100%; margin: 0px; border :0px; padding:0px; " cellspacing="0px;" cellpadding="0px;">
                    <tr style="height:30px;">
			            <td align="center">
				            <asp:label id="title" runat="server"><b>Locations</b></asp:label>
                        </td>
                    </tr>
                </table> 
                 <asp:CoolGridView ID="gvTable" runat="server" Caption="" 
                   CssClass="GridStyle" GridLines="None" DataSourceID="sdsLocGrid" 
                   EmptyDataText="No location currently available" Height="480px" Width="100%"
                   AutoGenerateColumns="False" AutoGenerateDeleteButton="True" 
                   onselectedindexchanged="gvTable_SelectedIndexChanged"  onselectedindexchanging="gvTable_SelectedIndexChanging"
                   DataKeyNames="id" FixHeaders="false" AllowPaging="True"  AllowSorting="True" PageSize="15" PagerStyle-BackColor="#f2e8da" PagerSettings-Mode="NumericFirstLast" AllowResizeColumn="True"
                   EnableTheming="False"
                 ...
                 >
                     <Columns>
                       ...
                       <ItemTemplate>
                         ...
                         <asp:BoundField DataField="contact_employee" HeaderText="Contact" ReadOnly="True" SortExpression="contact_employee"  />
