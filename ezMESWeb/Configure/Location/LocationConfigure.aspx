                 ...
                 >
                     <Columns>
                       ...
                       <ItemTemplate>
                         ...
                         <asp:BoundField DataField="parent_loc_id" HeaderText="Parent_Loc_Id" ReadOnly="True" SortExpression="parent_loc_id" Visible="true" />
                         <asp:BoundField DataField="adjacent_loc_id1" HeaderText="Adjacent_Loc_Id1" ReadOnly="True" SortExpression="adjacent_loc_id1" Visible="true" />
                         <asp:BoundField DataField="adjacent_loc_id2" HeaderText="Adjacent_Loc_Id2" ReadOnly="True" SortExpression="adjacent_loc_id2" Visible="true" />
                         <asp:BoundField DataField="adjacent_loc_id3" HeaderText="Adjacent_Loc_Id3" ReadOnly="True" SortExpression="adjacent_loc_id3" Visible="true" />
                         <asp:BoundField DataField="adjacent_loc_id4" HeaderText="Adjacent_Loc_Id4" ReadOnly="True" SortExpression="adjacent_loc_id4" Visible="true" />
