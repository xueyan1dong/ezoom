<%@ Page Language="C#" MasterPageFile="../ConfigureModule.Master" AutoEventWireup="true" CodeBehind="ClientConfig.aspx.cs" Inherits="ezMESWeb.Configure.Client.ClientConfig" Title="Client Configuration -- ezOMM" %>
