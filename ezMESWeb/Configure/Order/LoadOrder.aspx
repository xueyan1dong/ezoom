        ...
        <table class="auto-style1">
            <tr>
                ...
                <td class="auto-style4">
                    <asp:FileUpload ID="orderFile" runat="server" Width="326px" Height="25px" />
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td colspan="3">
    <asp:TextBox ID="txtOrder" runat="server" TextMode="MultiLine" Visible="False" Width="600px"></asp:TextBox>
                    <br />
                    <asp:ListBox ID="lstOrder" runat="server" Visible="False"></asp:ListBox>
                </td>
            </tr>
            <tr>
                <td></td>
                ...
                <td class="auto-style5">
                    <asp:FileUpload ID="prodFile" runat="server" Width="327px" Height="25px" ToolTip="Select order file" />
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td colspan="3" class="auto-style8">
                    <asp:TextBox ID="txtProduct" runat="server" TextMode="MultiLine" Visible="False" Width="600px"></asp:TextBox>
                    <br />
                    <asp:ListBox ID="lstProduct" runat="server" Visible="False"></asp:ListBox>
                </td>
            </tr>
            <tr>
