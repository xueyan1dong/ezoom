<%@ Page Language="C#" MasterPageFile="./ConfigOrganization.Master" AutoEventWireup="true" CodeBehind="ConfigHostOrganization.aspx.cs" Inherits="ezMESWeb.Configure.User.ConfigHostOrganization" Title="Host Organization Configuration -- ezOOM"%>
   ...
   <asp:UpdatePanel ID="gvTablePanel" runat="server" UpdateMode="Conditional">
            <ContentTemplate>
                  <% if (Session["Role"].Equals("Admin"))
                     {%> 
            <asp:GridView ID="gvTable" runat="server" Caption="Host Organization List" 
     ...
     <%}
                     ...
                     { %>
              <asp:GridView ID="gvTable1" runat="server" Caption="Host Organization List" 
               CssClass="datagrid" GridLines="None" DataSourceID="sdsOrgConfigGrid" 
               EmptyDataText="No Client currently available" Height="145px" Width="500px"
