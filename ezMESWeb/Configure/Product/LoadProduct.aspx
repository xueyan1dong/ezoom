<%@ Page Language="C#" MasterPageFile="~/Configure/ConfigureModule.master" AutoEventWireup="true" CodeBehind="LoadProduct.aspx.cs" Inherits="ezMESWeb.Configure.Product.LoadProduct" Title= "Load Product -- ezOOM" %>
...
<asp:Label ID="lblError" runat="server" ForeColor="#FF3300" 
    ...
    <p>Required columns: Product_Group, Name, Lot_Size, Unit, LifeSpan, Description, Comment.</p><br />
    <p>Examples: general, TestProduct, 10, unit, 5, a test description, a test comment</p><br />
