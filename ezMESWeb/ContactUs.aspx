...
<asp:ToolkitScriptManager ID="ToolkitScriptManager1" runat="server" />
 <div style="padding-left:5px;">
    <p style="padding-bottom:10px; font-size:14px; font-weight:bold">
      From:<br />
      <asp:TextBox ID="txtFrom" runat="server" Columns="35" ReadOnly="True">  </asp:TextBox></p>
      
     <p style="padding-bottom:10px; font-size:14px; font-weight:bold">
      Additional Contact Information:<br />
      <asp:TextBox ID="txtContact" runat="server" Columns="35" MaxLength="255"></asp:TextBox></p>   
    <p style="padding-bottom:10px; font-size:14px; font-weight:bold">
      Subject:<br />
      <asp:TextBox ID="txtSubject" runat="server" Columns="50" MaxLength="255" /></p>
    <p style="padding-bottom:10px; font-size:14px; font-weight:bold">
      Body:<br />
